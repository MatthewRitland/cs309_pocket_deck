...
public class PeopleController {
    ...
    public String createPersonByPath (@PathVariable String name) {
    ...
    @PostMapping("/peopleParam")
    public String createPersonByParams (@RequestParam("firstName") String fName,
                                        @RequestParam("lastName") String lName,
                                        @RequestParam("address") String address,
                                        @RequestParam("telephone") String phone) {
        Person person = new Person(fName, lName, address, phone);
        peopleList.put(fName, person);
        return "new person " + fName + " saved";
    }
    ...
    public List<Person> getPersonByPath(@PathVariable String address) {
    ...
    @PutMapping("/peopleParam/{firstName}")
    public Person updatePersonByParams(@PathVariable String firstName, @RequestParam("firstName") String fName,
                                       @RequestParam("lastName") String lName, @RequestParam("address") String address,
                                       @RequestParam("telephone") String phone) {
